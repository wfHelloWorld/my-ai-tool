...
import type { Wan21ImageEditProgress } from "../providers/imgGen/Wanxiang21ImageEditProvider";
...
export const useWanxiang21ImageEditStatusStore = defineStore("wanxiang21ImageEditStatus", {
  ...
  actions: {
    ...
    append(info: Wan21ImageEditProgress & { clientId?: string; name?: string }) {
